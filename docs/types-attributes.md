...
| `fusion_group_name`      | `MonStgElt`                     | The name of the fusion group i.e. the result of ``GroupName(F`fusion_group)``                            |
| `indecomposable`         | `BoolElt`                       | True if the fusion system is indecomposable.                                                             |
| `factors`                | `SeqEnum[Tup]`                  | Stores the SmallFusionSystem ids of the factors of the fusion system as a sequence of tuples.            |
| `small_id`               | `Tup`                           | Stores the SmallFusionSystem id of the fusion system.                                                    |
